<template>
  <div class="h-full"  :class='{"flex": isInline}'>
    <div
      ...
      "
      :class='[{"flex items-center py-2": isInline, "max-w-sm  pb-16 rounded-lg": !isInline}]'
    >
      <a
        href="#"
        v-if="product.image"
        class="block flex items-center justify-center"
        :class='[{"min-w-[120px] max-w-[120px] h-[120px]": isInline, " h-60 ": !isInline}]'
      >
        <img
          class="rounded-t-lg"
          :class='[{"p-4 ": !isInline}]'
      ...
      <div class="px-5 pb-2" :class='[{"w-full": isInline }]'>
        ...
        <div class="flex items-center justify-between" :class='[{"text-sm": isInline}]'>
        ...
        <div class=" bottom-4 w-full left-0 right-0"  :class='[{"py-1": isInline, "absolute px-5": !isInline}]'>
          ...
          <div class="flex items-center justify-between w-full">
            ...
            <a
              ...
              class="
                ...
                text-center
              "
              :class='[{"px-4 py-1 rounded-md": isInline, "px-5 py-2.5 rounded-lg": !isInline}]'
              >В корзину</a
            >
          </div>
        </div>
